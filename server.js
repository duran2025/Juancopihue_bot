...
// Verificador: busca coincidencias literales de palabras clave y devuelve
// el texto real indexado, sin pasar por la IA — para confirmar con certeza
// si algo específico quedó bien indexado.
app.get("/api/admin/verify-keyword", checkAdminPassword, (req, res) => {
  const query = typeof req.query.q === "string" ? req.query.q : "";
  const matches = searchKeyword(query, 10);
  res.json({
